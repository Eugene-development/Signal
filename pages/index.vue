        ...
        <div class="relative mx-auto max-w-md px-4 sm:max-w-3xl sm:px-6 lg:px-0">
          ...
          <div class="pt-12 sm:pt-16 lg:pt-20">
            ...
            <div class="mt-6 text-gray-500 space-y-6">
              ...
              <ul>
                <li class="py-2"><b>Проектировщик:</b> осуществить разработку проектной сметной документации любой
                  сложности с соблюдением всех нормативных документов по указанным видам работ;</li>
                <li class="py-2"><b>Генеральный подрядчик:</b> выполнит монтаж систем любой сложности и произведет контроль
                  выполнения работ;</li>
                <li class="py-2"><b>Технический консультант:</b> окажет квалифицированную консультацию, разработает
